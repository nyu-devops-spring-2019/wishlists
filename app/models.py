 ...
 ######################################################################
 """
 Wishlists Model that uses Cloudant
 ...
 ######################################################################
     ...
     def find_by_item_id(cls, item_id):
         """ Query that finds Items by their item_id """
